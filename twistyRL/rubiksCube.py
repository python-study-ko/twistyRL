...
class rubiksCube( Cube ) :
    ...
    def __repr__( self ) :
        ...
        nullArea = ' ' * (6 + sample * 3)
        stick1Area = '-' * (6 + sample * 3)
        stick2Area = ' ' + '-' * (21 + sample * 12) + '\n'
        str = '============================================\n'
        str += '  루빅스 큐브 게임 3*3*3\n\n'
        str += '{}{}    완료 여부 : {done}\n'.format( nullArea, stick1Area, done=self.done )
        str += '{}| {} {} {} |    점수      : {point}\n'.format( nullArea, f2[ 0 ][ 0 ], f2[ 0 ][ 1 ], f2[ 0 ][ 2 ],
                                                               point=self.point )
        ...
        str += ' | {} {} {} | {} {} {} | {} {} {} | {} {} {} |\n'.format( f3[ 0 ][ 0 ], f3[ 0 ][ 1 ], f3[ 0 ][ 2 ],
                                                                          ...
                                                                          f4[ 0 ][ 0 ], f4[ 0 ][ 1 ], f4[ 0 ][ 2 ],
                                                                          f6[ 0 ][ 0 ], f6[ 0 ][ 1 ], f6[ 0 ][ 2 ] )
        str += ' | {} {} {} | {} {} {} | {} {} {} | {} {} {} |\n'.format( f3[ 1 ][ 0 ], f3[ 1 ][ 1 ], f3[ 1 ][ 2 ],
                                                                          f1[ 1 ][ 0 ], f1[ 1 ][ 1 ], f1[ 1 ][ 2 ],
                                                                          f4[ 1 ][ 0 ], f4[ 1 ][ 1 ], f4[ 1 ][ 2 ],
                                                                          f6[ 1 ][ 0 ], f6[ 1 ][ 1 ], f6[ 1 ][ 2 ] )
        str += ' | {} {} {} | {} {} {} | {} {} {} | {} {} {} |\n'.format( f3[ 2 ][ 0 ], f3[ 2 ][ 1 ], f3[ 2 ][ 2 ],
                                                                          f1[ 2 ][ 0 ], f1[ 2 ][ 1 ], f1[ 2 ][ 2 ],
                                                                          f4[ 2 ][ 0 ], f4[ 2 ][ 1 ], f4[ 2 ][ 2 ],
                                                                          f6[ 2 ][ 0 ], f6[ 2 ][ 1 ], f6[ 2 ][ 2 ] )
        str += stick2Area
        str += '{}| {} {} {} |\n'.format( nullArea, f5[ 0 ][ 0 ], f5[ 0 ][ 1 ], f5[ 0 ][ 2 ] )
        str += '{}| {} {} {} |\n'.format( nullArea, f5[ 1 ][ 0 ], f5[ 1 ][ 1 ], f5[ 1 ][ 2 ] )
        str += '{}| {} {} {} |\n'.format( nullArea, f5[ 2 ][ 0 ], f5[ 2 ][ 1 ], f5[ 2 ][ 2 ] )
        ...
        turnset = {
            'F' : {  # 완료
                ...
                'change' : {
                    ...
                    3 : { 'num' : 2, 'index' : 'c2', 'flip' : True },
                    4 : { 'num' : 5, 'index' : 'c0', 'flip' : True },
                    5 : { 'num' : 3, 'index' : 'r2', 'flip' : False },
                }
            },
            'F`' : {  # 완료
                'rotate' : {
                ...
                'change' : {
                    2 : { 'num' : 3, 'index' : 'r2', 'flip' : True },
                    3 : { 'num' : 5, 'index' : 'c0', 'flip' : False },
                    4 : { 'num' : 2, 'index' : 'c2', 'flip' : False },
            ...
            'R' : {  # 완료
                ...
                'change' : {
                    1 : { 'num' : 2, 'index' : 'r2', 'flip' : False },
                    2 : { 'num' : 6, 'index' : 'r0', 'flip' : True },
                    5 : { 'num' : 1, 'index' : 'r2', 'flip' : False },
                    6 : { 'num' : 5, 'index' : 'r2', 'flip' : True },
                }
            },
            'R`' : {  # 완료
                'rotate' : {
                ...
                'change' : {
                    1 : { 'num' : 5, 'index' : 'r2', 'flip' : False },
                    2 : { 'num' : 1, 'index' : 'r2', 'flip' : False },
                    5 : { 'num' : 6, 'index' : 'r0', 'flip' : True },
                    6 : { 'num' : 2, 'index' : 'r2', 'flip' : True },
                }
            },
            'U' : {  # 완료
                'rotate' : {
            ...
            'B' : {  # 완료
                ...
                'change' : {
                    ...
                    3 : { 'num' : 5, 'index' : 'c2', 'flip' : False },
                    4 : { 'num' : 2, 'index' : 'c0', 'flip' : False },
                    5 : { 'num' : 4, 'index' : 'r2', 'flip' : True },
                }
            },
            'B`' : {  # 완료
                'rotate' : {
                ...
                'change' : {
                    2 : { 'num' : 4, 'index' : 'r2', 'flip' : False },
                    3 : { 'num' : 2, 'index' : 'c0', 'flip' : True },
                    4 : { 'num' : 5, 'index' : 'c2', 'flip' : True },
            ...
            'D' : {  # 완료
                ...
                'change' : {
                    1 : { 'num' : 4, 'index' : 'c2', 'flip' : False },
                    3 : { 'num' : 1, 'index' : 'c2', 'flip' : False },
                    4 : { 'num' : 6, 'index' : 'c2', 'flip' : False },
                    6 : { 'num' : 3, 'index' : 'c2', 'flip' : False },
                }
            },
            'D`' : {  # 완료
                'rotate' : {
                ...
                'change' : {
                    1 : { 'num' : 3, 'index' : 'c2', 'flip' : False },
                    3 : { 'num' : 6, 'index' : 'c2', 'flip' : False },
                    4 : { 'num' : 1, 'index' : 'c2', 'flip' : False },
                    6 : { 'num' : 4, 'index' : 'c2', 'flip' : False },
                }
            },
        }
        # 명령어셋 확인
